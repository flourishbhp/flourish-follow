...
class BookingListboardView(NavbarViewMixin, EdcBaseViewMixin,
    ...
    listboard_template = 'flourish_follow_booking_listboard_template'
    listboard_url = 'flourish_follow_booking_listboard_url'
    ...
    ordering = '-modified'
    paginate_by = 6
    search_form_url = 'flourish_follow_booking_listboard_url'

    def get_success_url(self):
        return reverse('flourish_follow:flourish_follow_booking_listboard_url')
